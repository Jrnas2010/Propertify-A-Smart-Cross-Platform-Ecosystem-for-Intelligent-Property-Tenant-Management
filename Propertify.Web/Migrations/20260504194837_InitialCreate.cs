        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitorName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElectricityMeter = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    WaterMeter = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Bedrooms = table.Column<int>(type: "int", nullable: false),
                    Bathrooms = table.Column<int>(type: "int", nullable: false),
                    Kitchens = table.Column<int>(type: "int", nullable: false),
                    LivingRooms = table.Column<int>(type: "int", nullable: false),
                    Majlis = table.Column<int>(type: "int", nullable: false),
                    UnitImages = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cost = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 3, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondNameAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ThirdNameAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    SecondNameEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ThirdNameEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UtilityBills_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UtilityBills_TenantId",
                table: "UtilityBills",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_UtilityBills_UnitId",
                table: "UtilityBills",
                column: "UnitId");
        }
